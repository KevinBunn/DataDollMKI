...
var commandHandlers = map[string]func(s *discordgo.Session, i *discordgo.InteractionCreate){
	...
	"upload-event": func(s *discordgo.Session, i *discordgo.InteractionCreate) {
		 ...
		 **/
		pairingsAttachmentId := fmt.Sprint(i.ApplicationCommandData().Options[4].Value)
		playersAttachmentId := fmt.Sprint(i.ApplicationCommandData().Options[5].Value)
		...
		event := structs.Event{
			...
			Pairings:     pairings,
			Date:         fmt.Sprint(i.ApplicationCommandData().Options[3].Value),
